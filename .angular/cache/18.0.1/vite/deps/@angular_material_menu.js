import {
  ...
  OverlayConfig,
  OverlayModule
} from "./chunk-MFZ4UJSV.js";
import {
  DomPortalOutlet,
  TemplatePortal
} from "./chunk-XY4RW3GX.js";
import {
  CdkScrollableModule
} from "./chunk-CSX55WOK.js";
import "./chunk-WP4QRHWZ.js";
import {
  animate,
  state,
  style,
...
} from "./chunk-VX65NSAB.js";
import {
  CommonModule,
  DOCUMENT
} from "./chunk-BWQWYAL5.js";
import {
  ApplicationRef,
...
var _MatMenuTrigger = class _MatMenuTrigger {
  ...
  _handleHover() {
    ...
    this._hoverSubscription = this._parentMaterialMenu._hovered().pipe(filter((active) => active === this._menuItemInstance && !active.disabled), delay(0, asap)).subscribe(() => {
      this._openedBy = "mouse";
      if (this.menu instanceof MatMenu && this.menu._isAnimating) {
        this.menu._animationDone.pipe(take(1), delay(0, asap), takeUntil(this._parentMaterialMenu._hovered())).subscribe(() => this.openMenu());
      } else {
        this.openMenu();
      }
    });
